		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ingresos",
									"targetURL": "#arcomrizobacteringresos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomrizobacteringresos-display": {
								"semanticObject": "arcomrizobacteringresos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.rizobacter.ingresos",
									"url": sap.ui.require.toUrl("ar/com/rizobacter/ingresos")
								}
							}
						}
					}
