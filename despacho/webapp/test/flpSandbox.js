		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Despachos",
									"targetURL": "#arcomrizobacterdespacho-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomrizobacterdespacho-display": {
								"semanticObject": "arcomrizobacterdespacho",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.rizobacter.despacho",
									"url": sap.ui.require.toUrl("ar/com/rizobacter/despacho")
								}
							}
						}
					}
